  ...
  return (
    <div className='w-screen aspect-video pt-[20%] px-6 md:px-12 absolute text-white bg-gradient-to-r from-black'>
        ...
        <div className='flex flow-root'>
            ...
            <button className='bg-[#fff] text-black text-x1 py-0 md:py-2 px-2 md:px-8 text-xl rounded hover:bg-opacity-70 items-center'>
                <img   className='w-6 h-6 float-left m-1'
                 src="src\Assets\—Pngtree—black vector play button icon_4231897 (1).png" 
                alt="Play" 
                />Play 
            </button>
            <button className='hidden md:inline-block mx-4 bg-gray-600 text-white p-2 px-8 text-xl rounded hover:bg-opacity-70 items-center'>
              <img className='w-6 h-6 float-left m-1'
